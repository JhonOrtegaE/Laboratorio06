...
public class FrameProfesor extends javax.swing.JFrame {
     ...
     * @param profesor
     */
    public FrameProfesor(laboratorio06.Profesor profesor) {
        initComponents();
         this.profesor = profesor;
    }
public FrameProfesor(JFrameProfesor padre, laboratorio06.Profesor profesor) {
        initComponents();
        this.padre = padre;
         this.profesor = profesor;
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameProfesor(null).setVisible(true);
            }
        });
    }
